...
main (int argc, char *argv[])
{
  ...
  printf ("%02d: Ben Denys\n", ++i);
  printf ("%02d: Jeremy Barker\n", ++i);
  printf ("%02d: Grant Buhl\n", ++i);
  printf ("%02d: Michael Miller\n", ++i);
  printf ("%02d: Maxx Lehmann\n" , ++i);
  printf ("%02d: Brennan Lautner\n", ++i);
  printf ("%02d: Richard Carpenter\n", ++i);
  printf ("%02d: Collin Bernard\n", ++i);
  printf ("%02d: Kate Weber\n", ++i);
  printf ("%02d: Jake Mager\n", ++i);
  printf ("%02d: Avery Bailey\n", ++i);
  printf ("%02d: Marlaina Wunderlich\n", ++i);
  printf ("%02d: Dylan Lettinga\n", ++i);
  printf ("%02d: Benjamin Slade\n", ++i);
  printf ("%02d: Keith Atkinson\n", ++i);
  printf ("%02d: Grayson Briggs\n", ++i);
  printf ("%02d: Dimitrios Kazakos\n", ++i);
  printf ("%02d: Michael Drogowski\n", ++i);
  printf ("%02d: Zack Posz\n", ++i);
  printf ("%02d: Brett Kriz\n", ++i);
  printf ("%02d: Jimmy Roznick\n", ++i);
  printf ("%02d: Amanda Charboneau\n", ++i);
  printf ("%02d: Catherine Steigerwald\n", ++i);
  printf ("%02d: Elijah Pass\n", ++i);
  printf ("%02d: BJ Kent\n", ++i);
  printf ("%02d: Amber Varacalli\n", i++);
